...
export function CatalogButton() {
  ...
  return (
    ...
    {/* Mobile PDF Viewer with @react-pdf-viewer */}
      {showCatalog && isMobile && (
        <div className="w-full max-h-[80vh] overflow-hidden rounded-lg border">
          <iframe
            src={`/assets/pdf/CV-Fadi-Batraki.pdf#toolbar=1&navpanes=0&scrollbar=1`}
            className="w-full h-[80vh]"
            title="Catalog Mobile Preview"
          />
        </div>
      )}
    </div>
